...
shore = st_read("./WSDOT_major_shorlines/MajorShorelines.shp")# Read in Washington data
...
PS_site_map = ggplot() +
  ...
  geom_sf(data = shore, fill = "#8BAAB8", col = "#626060")+#shapefiles can be downloaded for specific arfeas
